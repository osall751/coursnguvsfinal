...
export class RendezVousService {
  ...
  chercher(str: any) {
    ...
    console.log('### ' + str);
    if (str.length)
      this.rvs = this.rvs.filter((varRv) => {
        return (
          varRv.description.toLocaleLowerCase().match(str) ||
          varRv.lieu.toLocaleLowerCase().match(str)
        );
      });
    else {
      this.rvs = this.copieRvs;
    }
  }
